...
const FolderMidtermQuestionPaper: React.FC = () => {
  ...
  const [paperData, setPaperData] = useState<MidtermPaper>({
    semester: '',
  ...
  return (
    <DashboardLayout userRole={userRole}>
      <div className="p-4 md:p-6">
        ...
        <h2 className="text-base md:text-lg font-semibold text-gray-800 mb-4">Midterm Question Paper</h2>
        ...
        <div className="bg-white border border-gray-300 rounded-md shadow-sm p-6 md:p-8 max-w-4xl mx-auto" ref={printRef}>
          ...
          <div className="text-center mb-6">
            ...
            <div className="text-base font-bold text-gray-800">MIDTERM {paperData.semester || ''}</div>
            <div className="text-sm font-normal text-gray-700">Mid Term Exam </div>
          </div>

          <hr className="border-gra300 my-4" />
            ...
            <button
              onClick={() => {
                ...
                try {
                  ...
                  printHtmlContent('Midterm Paper', printRef.current);
        ...
        {isCoordinatorReview && submittedStatuses.has((status || '').toUpperCase()) && isReviewContext && (
          <CoordinatorFeedbackBox folderId={id} section="MIDTERM_QUESTION_PAPER" />
        )}

        {isAuditMemberReview && submittedStatuses.has((status || '').toUpperCase()) && (
          <AuditMemberFeedbackBox folderId={id} section="MIDTERM_QUESTION_PAPER" />
        )}
      </div>
    </DashboardLayout>
  );
...
export default FolderMidtermQuestionPaper;
