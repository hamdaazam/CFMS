...
import { FolderCheck, Loader2, BookOpen, Calendar } from 'lucide-react';
...
export const HODCompletedFolders: React.FC = () => {
  const { user } = useAuth();
      ...
      <div className="p-8 space-y-6">
        <div>
          ...
          <p className="text-gray-600 mt-2">
            Folders that have been fully approved and completed
          </p>
        </div>
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-lg shadow-md p-12 text-center">
            ...
            <p className="text-gray-500">
              Approved folders will appear here.
            </p>
          </div>
        ) : (
            ...
            {folders.map((folder) => (
              <div key={folder.id} className="bg-white rounded-lg shadow-sm border border-gray-100 p-6 space-y-4">
                ...
                <div className="flex items-center text-sm text-gray-600">
                  ...
                  Approved on {formatDate(folder.submitted_at)}
                </div>
