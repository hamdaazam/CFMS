...
export const AuditMemberNotifications: React.FC = () => {
  const { user } = useAuth();
  ...
  const handleNotificationClick = (notification: Notification) => {
    ...
    if (notification.folder && notification.folder.id) {
      navigate(`/audit-member/folder/${notification.folder.id}/title-page`);
    }
  };
  ...
  if (loading) {
    return (
      <DashboardLayout userRole="faculty" userName={user?.full_name || 'Audit Member'} userAvatar={user?.profile_picture || undefined}>
