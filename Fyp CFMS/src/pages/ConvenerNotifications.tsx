...
export const ConvenerNotifications: React.FC = () => {
  const { user } = useAuth();
  ...
  const handleNotificationClick = (notification: Notification) => {
    ...
    if (notification.folder && notification.folder.id) {
      navigate(`/convener/folder/${notification.folder.id}/title-page`);
    }
  };
  ...
  if (loading) {
    return (
      <DashboardLayout userRole="convener" userName={user?.full_name || 'Convener'} userAvatar={user?.profile_picture || undefined}>
