...
export const CoordinatorNotifications: React.FC = () => {
  const { user } = useAuth();
  ...
  const handleNotificationClick = (notification: Notification) => {
    ...
    if (notification.folder && notification.folder.id) {
      navigate(`/coordinator/folder/${notification.folder.id}/title-page`);
    }
  };
  ...
  if (loading) {
    return (
      <DashboardLayout userRole="coordinator" userName={user?.full_name || 'Coordinator'} userAvatar={user?.profile_picture || undefined}>
